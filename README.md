...
<p align="center">
  <img src="Screenshot_20260408_112148_Spck Editor.jpg" width="280" alt="Écran de Verrouillage PIN" />
...
- **Frontend** : HTML5 sémantique & CSS3 (Architecture de variables pour thèmes).
- **Logique** : Vanilla JavaScript (ES6+) — *Aucun framework lourd pour une performance maximale.*
- **UI/UX** : 
  - **Fonts** : Syne (titres) & Inter (corps).
  - **Icons** : FontAwesome 6.4.0.
  - **Feedback** : Retours haptiques (vibrations) lors des interactions critiques.
- **Rapports** : Librairie `html2pdf.js`.
